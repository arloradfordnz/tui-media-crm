...
export default function PlatformIcon({ platform, className = 'w-4 h-4', style }: Props) {
  ...
  if (platform === 'instagram') {
    // fillRule="evenodd" is required so the inner lens circle is subtracted
    // from the outer rounded square — otherwise the whole glyph renders as
    // a solid blob and visually reads as a circle at small sizes.
    return (
      <svg {...common} fill="currentColor" fillRule="evenodd" clipRule="evenodd" aria-hidden="true">

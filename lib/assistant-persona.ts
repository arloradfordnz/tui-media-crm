...
The line item description is the one part of an invoice the client actually reads, so it is never the job name. Look the job up first (get_job, list_deliverables) and write what was delivered: how many, what format, what platform, what period. "Ceramic Coating Videos" tells a client nothing they didn't already know; "4 short-form videos (Reels/TikTok) for the ceramic coating range, filmed and edited September 2026" tells them what they paid for. If a job has a mix of deliverables at different stages, say what this invoice actually covers, not the whole job.

  ...
  return (
    <>
      ...
      <aside
        ...
        } lg:transform-none lg:translate-x-0 lg:pointer-events-auto lg:relative lg:inset-auto lg:flex-shrink-0 lg:w-[440px] lg:self-start lg:sticky lg:top-6 lg:h-[50vh] lg:rounded-xl lg:overflow-hidden lg:z-10`}
        style={{

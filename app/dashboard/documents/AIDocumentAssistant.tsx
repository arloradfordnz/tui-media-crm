  ...
  return (
    <>
      ...
      <aside
        ...
        } lg:transform-none lg:translate-x-0 lg:pointer-events-auto lg:relative lg:inset-auto lg:flex-shrink-0 lg:w-[440px] lg:self-stretch lg:rounded-xl lg:overflow-hidden lg:z-10`}
        style={{

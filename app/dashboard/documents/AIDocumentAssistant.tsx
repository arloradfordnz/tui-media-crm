  ...
  return (
    <>
      ...
      <aside
        ...
        } lg:transform-none lg:translate-x-0 lg:pointer-events-auto lg:flex-shrink-0 lg:w-[440px] lg:self-start lg:sticky lg:inset-auto lg:top-[80px] lg:h-[calc(100vh-104px)] lg:rounded-xl lg:overflow-hidden lg:z-30`}
        style={{

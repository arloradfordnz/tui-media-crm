...
// One record, four questions. The page was a 780-line single scroll: proposal,
// details, tasks, deliverables, revisions, time, activity, all stacked. Every
// visit meant scrolling past four things you did not come for, and on a phone
// the activity log at the bottom was effectively unreachable.
//
// The split follows what you actually arrive wanting to know — what's left to
// do, what's been sent, what it's worth, what's happened — rather than the
// order the tables happen to be in.
    ...
    <div className="space-y-6">
      ...
      <RecordTabs
        ...
        tabs={[
          ...
          { id: 'activity', label: 'Activity', count: job.activities.length },
        ]}
      />

      <RecordPanel id="work" active={tab === 'work'}>
        {/* Job Type & Notes */}
      ...
      <RecordPanel id="deliverables" active={tab === 'deliverables'}>
        {/* Deliverables */}
        <div className="card">
      ...
      <RecordPanel id="money" active={tab === 'money'}>
        {/* Proposal */}
        <div className="card">
          <div className="flex items-center justify-between mb-4">
      ...
      <RecordPanel id="activity" active={tab === 'activity'}>
        {/* Activity Log */}
        <div className="card">
